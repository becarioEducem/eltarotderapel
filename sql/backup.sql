...
CREATE TABLE `contactus` (
  ...
  `prefday` smallint(6) DEFAULT NULL,
  `preftime` smallint(6) DEFAULT NULL,
...
-- password => SHA1(eltarotderapel1234)
INSERT INTO `users` VALUES ('admintarot','e024b1fbfc71cb4e3431c8042515cb033ecd103f');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;

--
-- Dumping routines for database 'tarot'
--
...
-- Dump completed on 2021-03-12  3:12:59
